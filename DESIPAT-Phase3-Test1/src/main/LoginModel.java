...
public class LoginModel {
	 ...
	 * @throws SQLException
	 */
	public boolean checkMatch(UserModel umdl, JTextField username, JPasswordField password) throws SQLException {
		try {
			if (umdl.getUsername().equals(username.getText()) && umdl.getPassword().equals(password.getText())) {
				return true;
			}
		} catch (Exception e) {
